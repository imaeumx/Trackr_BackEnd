...
SECRET_KEY = os.environ.get(
    'SECRET_KEY', 
    'django-insecure-local-development-key-only-change-in-production'
)

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False').lower() in ('true', '1', 'yes')  # False in production
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'TrackR <jvmsunga.student@ua.edu.ph>')
